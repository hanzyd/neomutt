...
enum PagerMode
{
    ...
    PAGER_MODE_ATTACH_E,    ///< A special case of PAGER_MODE_ATTACH - attacment is a full-blown email message
    PAGER_MODE_HELP,        ///< Pager is invoked via 3ed path to show help.
...
struct PagerView
{
  struct PagerData* data;         ///< Data that pager displays. NOTNULL
