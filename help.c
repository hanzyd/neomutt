...
void mutt_help(enum MenuType menu)
{
  ...
  view.flags = MUTT_PAGER_RETWINCH | MUTT_PAGER_MARKER | MUTT_PAGER_NSKIP | MUTT_PAGER_NOWRAP;
  ...
  do
  {
    ...
    data.fname  = mutt_buffer_string(&t);
    view.banner = banner;
  } while (mutt_do_pager(&view) == OP_REFORMAT_WINCH);
